...
**女生面部与身形修饰版（2026-09-26）：** 5 张照片均使用内置 `image_gen` 在已有写真上编辑，适度修饰脸颊、下颌线、肩颈与手臂轮廓，优化上半身衣裙线条，保留人物辨识度、自然孕肚、原有场景和合照中男生的形象。照片沿用原文件名；此前版本保留在 Git 历史中。完整提示词见 [女生修饰提示词](RETOUCH_PROMPTS.md)。

**男生身材修正记录（2026-09-25）：** 三张夫妻合照曾依据用户补充的真实全身照重新编辑，调整男生的相对身高、肩宽、躯干与四肢比例。完整编辑提示词见 [身材修正提示词](BODY_CORRECTION_PROMPTS.md)。
